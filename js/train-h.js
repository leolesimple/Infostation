...
function updateHorairesv2(stopId = 58566) {
    ...
    const urlArret = "./json/arrets-train-h.json";
    const urlMission = "./json/dessertes/train-h.json";
...
function prochainTrain() {
    ...
    monitoredStopVisits.forEach((stopVisit, index) => {
            ...
            if (operatorRef.startsWith("SNCF_ACCES_CLOUD")) {
                ...
                if (station.startsWith("Gare de la")) {
                ...
                if (destinationDisplay.startsWith("Gare du") || destinationDisplay === "Gare du Nord") {
                    destName = "Paris Nord"
                }
                ...
                if (lineref === "STIF:Line::C01737:" && operatorRef.startsWith("SNCF_ACCES_CLOUD") && destName !== station) {
                    mission = monitoredVehicleJourney.JourneyNote[0].value;

                    if (station === "Paris Nord" || station === "Crepy en Valois") {
                        if (retard === 'delayed') {
