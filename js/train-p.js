...
function updateHorairesv2(stopId = 58566) {
    ...
    const urlArret = "./json/arrets-train-p.json";
    const urlMission = "./json/dessertes/train-p.json";
...
function prochainTrain() {
    ...
    monitoredStopVisits.forEach((stopVisit, index) => {
            ...
            if (operatorRef.startsWith("SNCF_ACCES_CLOUD")) {
                ...
                } else if (station.startsWith("Gare de la")) {
                    station = station.replace("Gare de la", "La");
                ...
                if (destinationDisplay.startsWith("Gare de l'") || destinationDisplay === "Gare de l'Est") {
                    destName = "Paris Est"
                }
                ...
                if (lineref === "STIF:Line::C01730:" && operatorRef.startsWith("SNCF_ACCES_CLOUD") && destName !== station) {
                    mission = monitoredVehicleJourney.JourneyNote[0].value;

                    if (station === "Paris Est" || station === "Meaux" || station === "La Ferté Milon" || station === "Château Thierry" || station === "Coulommiers" || station === "Provins" || station === "Esbly" || station === "Crécy-la-Chapelle") {
                        if (retard === 'delayed') {
