...
function updateHorairesv2(stopId = 58566) {
    ...
    const urlArret = "./json/arrets-traink.json";
    const urlMission = "./json/dessertes/train-k.json";
...
function prochainTrain() {
    ...
    monitoredStopVisits.forEach((stopVisit, index) => {
            ...
            if (operatorRef.startsWith("SNCF_ACCES_CLOUD")) {
                ...
                if (lineref === "STIF:Line::C01738:" && operatorRef.startsWith("SNCF_ACCES_CLOUD") && destName !== station) {
